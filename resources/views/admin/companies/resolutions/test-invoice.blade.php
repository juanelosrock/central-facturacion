<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800">
                🧾 Factura de prueba — {{ $company->business_name }}
            </h2>
    ...
    <div class="py-8 max-w-6xl mx-auto sm:px-6 lg:px-8" x-data="testInvoiceEditor()">
        ...
        <div class="bg-white shadow rounded overflow-hidden">
            ...
            <div class="bg-gray-800 px-4 py-3 flex items-center gap-3">
                <span class="px-3 py-1 bg-orange-500 text-white text-xs font-bold rounded font-mono">POST</span>
                <code class="text-green-300 text-sm flex-1 truncate">
                    {{ rtrim(App\Models\Setting::get('qimera_api_url', ''), '/') }}/ubl2.1/invoice
                </code>
            ...
            <div class="flex" style="min-height: 520px;">
                ...
                <div class="w-72 flex flex-col bg-gray-50">
                    ...
                    <div class="p-4 text-xs space-y-3 flex-1">
                        ...
                        <div>
                            <p class="font-semibold text-gray-500 uppercase text-xs mb-1">Resolución habilitación</p>
                        ...
                        <div class="pt-2 border-t border-gray-200">
                            <p class="font-semibold text-gray-500 uppercase text-xs mb-1">Notas</p>
                            <ul class="text-gray-500 space-y-1">
                                <li>• La fecha/hora se actualiza al recargar</li>
                                <li>• Podés editar cualquier campo antes de enviar</li>
                                <li>• El número de factura debe ser único</li>
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <form method="POST" action="{{ route('admin.companies.resolutions.test-invoice', $company) }}"
                ...
                <div class="bg-gray-800 px-4 py-3 flex items-center justify-between">
                    <div class="text-xs text-gray-400">
                        Endpoint: <code class="text-gray-300">POST /ubl2.1/invoice</code>
                    </div>
                    <button type="submit"
                            :disabled="!jsonValid"
                            :class="jsonValid
